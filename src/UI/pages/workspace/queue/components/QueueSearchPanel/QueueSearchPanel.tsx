...
type QueueSearchPanelProps = {
  searchValues: QueueSearchBodyType;
  close(): void;
  search(values: QueueSearchBodyType): Promise<void>;
  onReset(): void;
  cinemaDictionary: CinemaDictionary | null;
};

const QueueSearchPanel: React.FC<QueueSearchPanelProps> = ({
  cinemaDictionary,
  close,
  search,
  searchValues,
  ...
  return (
    <>
      ...
      <div className="QueueSearchPanel side-panel-form">
              ...
              <Form className="side-panel-form__form">
                <SidePanelContentContainer className="side-panel-form__body">
                  ...
                  <Box className="full-width-form-control">
                    ...
                    >
                      {Object.values(QueueItemStatusEnum).map((status) => (
